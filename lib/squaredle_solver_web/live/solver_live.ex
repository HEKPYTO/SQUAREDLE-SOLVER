defmodule SquaredleSolverWeb.SolverLive do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok, assign(socket, grid: "", words: [], trie: %{}, loading: true, solving: false),
     layout: false}
  end
  ...
  def handle_info(:do_solve_daily, socket) do
    case SquaredleSolver.DailyFetcher.fetch_today_puzzle() do
      {:ok, grid_str} ->
        ...
        {:noreply, assign(socket, grid: grid_str, words: words, solving: false)}
              ...
              >
                <div class="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    class="border-4 border-black p-4 sm:p-6 text-2xl tracking-[0.2em] uppercase font-black text-center focus:outline-none placeholder:text-gray-200 ring-0 focus:ring-0"
                    style="box-shadow: 4px 4px 0px 0px rgba(0,0,0,1) !important;"
                  />
                </div>
